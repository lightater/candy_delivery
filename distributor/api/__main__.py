"""
REST API сервис, распределяющий заказы по курьерам.
"""
import argparse
import logging
import os
...
from distributor.api.app import create_app
from distributor.utils.argparse import clear_environ, positive_int
from distributor.utils.pg import DEFAULT_PG_URL


ENV_VAR_PREFIX = 'DISTRIBUTOR_'
