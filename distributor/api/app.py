...
from distributor.api.handlers import HANDLERS
from distributor.api.middleware import error_middleware, handle_validation_error
from distributor.api.payloads import AsyncGenJSONListPayload, JsonPayload
from distributor.utils.pg import setup_pg
...
def create_app(args: Namespace) -> Application:
    ...
    setup_aiohttp_apispec(app=app, title='Couriers API', swagger_path='/',
